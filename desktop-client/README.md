...
- 也可以从可选激活任务列表里手动选择某个客户/SIM 激活码，方便测试同一个码或从中断任务继续
...
6. 点击“领取下一个任务”；如果要测试指定激活码，点击“选择激活码任务”，从列表里选择对应客户/SIM 激活码。
...
手动选择任务列表只显示尚未写入手机号、尚未完成且仍有 SIM 激活码的任务；`激活中`、`等待人工支付`、`失败` 的任务也可以重新选择，方便测试和容错。
